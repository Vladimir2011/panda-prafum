...
Frontend интернет-магазина парфюмерии на Nuxt 4, Vue 3, TypeScript, Tailwind CSS, Nuxt UI и Reka UI.
...
- Nuxt UI используется для базовых элементов, форм, навигации и overlays.
- Reka UI используется напрямую только для нестандартных headless-компонентов.
- Компоненты каталога, товара, корзины и других доменных областей создаются в проекте.
- Фирменные палитры, размеры и варианты компонентов настраиваются в `app/app.config.ts` и `app/assets/css/main.css`.
